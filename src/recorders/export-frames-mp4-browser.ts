...
export const setupMp4BrowserRecord = ({
  ...
  muxer = new Muxer({
    ...
    video: {
      ...
      // wait for av1 to be more widely supported and switch in the future.
      // or, give users options to set their own.
  ...
  videoEncoder.configure({
    // codec: "avc1.42001f", // doesn't support 2k
    codec: "avc1.4d002a", // supports 2k
